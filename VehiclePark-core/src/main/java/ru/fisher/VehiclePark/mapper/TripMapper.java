...
//    public Mono<TripMapDTO> convertToTripMapDTOReactive(Trip trip, Long vehicleId, String enterpriseTimeZone, String clientTimeZone) {
//        Mono<TripDTO> tripDTOMono = convertToTripDTOReactiveWithTimeZones(trip, enterpriseTimeZone, clientTimeZone);
//
//        // Получаем поток GPS-данных
//        Flux<GpsData> gpsDataFlux = gpsDataReactiveService.findByVehicleAndTimeRange(
//                vehicleId,
//                trip.getStartTime(),
//                trip.getEndTime()
//        );
//
//        return tripDTOMono.flatMap(tripDTO -> {
//            TripMapDTO dto = new TripMapDTO();
//            dto.setTrip(tripDTO);
//
...
//    }
//
//    public Mono<TripDTO> convertToTripDTOReactiveWithTimeZones(Trip trip, String enterpriseZone, String clientZone) {
