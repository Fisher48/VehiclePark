...
class GpsDataServiceIntegrationTest {

    @Autowired
    private GpsDataService gpsDataService;

    @Test
    void getGpsDataByTripId_shouldAccelerateWithCache() {
        // 1-й вызов
        long start1 = System.nanoTime();
        gpsDataService.getGpsDataByTripId(1L);
        ...
        System.out.println("---getGpsDataByTripId---");
