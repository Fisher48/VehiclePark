...
//    @Test
//    void findTripsForEnterpriseInRange_shouldAccelerateWithCache() {
//        // Настройка мока
//        when(tripService.findTripsForEnterpriseInRange(enterpriseId, start, end))
//                .thenReturn(Collections.emptyList());
//
//        // Первый вызов (без кэша)
//        long startTime = System.nanoTime();
//        tripService.findTripsForEnterpriseInRange(enterpriseId, start, end);
...
//
//        logPerformance("findTripsForEnterpriseInRange", durationWithoutCache, durationWithCache);
//
